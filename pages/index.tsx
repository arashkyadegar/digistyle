...
export default function Home() {
  return (
    <>
        ...
        <div className="flex flex-col w-full relative">
          ...
          <div className=" absolute w-full text-black z-20 flex flex-col  mt-5">
            <div className="flex fex-row">
              ...
              {/* digistyle */}
              <div className="w-full mt-5  flex justify-center border-b border-black mx-6 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="207"
                  height="34"
              ...
              {/* search */}
              <div className="w-full  h-8 flex justify-center relative border-b border-black ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <input
                  type="text"
                  className="text-xs w-full text-center outline-none mb-2 bg-transparent"
            ...
            {/* second navbar */}
            <div className="mx-auto w-full text-black z-20 flex flex-row justify-center mt-5">
          ...
          >
            <SwiperSlide>
              <img
                className="w-full aspect-square  h-[500px] "
      ...
      <div className=" bg-[#F5F5F5] flex flex-col px-10 py-4 my-4">
        <div className="flex flex-row w-full ">
          <ul className="flex flex-row w-full px-10 text-2xl border-b-2 border-white">
            <li className=" w-1/5 sm:text-xl text-base text-center border-b-4 border-black p-2  ">
              مردانه
            </li>
      ...
      <div className=" flex flex-row justify-between px-10 py-2 my-4">
        <div>
