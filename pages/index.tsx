...
export default function Home() {
  return (
    <>
      <div className="flex flex-col  gap-10 mb-10 px-4">
        {/* first nav bar */}
        ...
        <div className=" bg-[#F5F5F5] flex flex-col px-10 py-4 ">
          <div className="flex flex-row w-full ">
            <ul className="flex flex-row w-full px-10 text-2xl border-b-2 border-white">
              ...
              <li className="w-1/5  sm:text-xl text-base text-center">
                زنانه
              </li>
              <li className="w-1/5 sm:text-xl text-base text-center">
                بچگانه
      ...
      <div className="flex flex-col gap-20 mb-10">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 w-4/5 mx-auto ">
